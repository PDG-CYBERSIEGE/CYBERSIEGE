...
/**
 * Base block of the game.
 * This class represents a destructible element displayed in the world.
 * It extends Table so it can contain several graphical sub-elements,
 * such as left, middle and right images to form a longer block.
 */
public class Block extends Table {
    ...
    /**
     * Resizes the block according to a size factor.
     * The width depends on the number of child elements, allowing blocks
     * made of several pieces to be assembled.
     *
