...
public final class GameMessages {
   ...
   * @return JSON message
   */
  public static String availableComponents(
      ArrayList<BlockDTO> blocks, KingDTO king, ArrayList<RobotDTO> robots) {
  ...
  private record AvailableComponentsMessage(
      String type, ArrayList<BlockDTO> blocks, KingDTO king, ArrayList<RobotDTO> robots) {}
