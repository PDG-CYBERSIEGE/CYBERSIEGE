...
public class MatchmakingService {
   ...
   */
  public synchronized PlayerConnection findMatch(
      String playerName, Long playerId, WebSocketConnection connection) {
    ...
    PlayerConnection playerConnection =
        new PlayerConnection(connection, playerName, playerId, connectionMatch);
